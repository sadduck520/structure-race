...
public class StructureRaceClient implements ClientModInitializer {
    ...
    private static KeyBinding leadAlertsKey;

    @Override
    public void onInitializeClient() {
        rulesKey = KeyBindingHelper.registerKeyBinding(new KeyBinding(
                "key.structure_race.rules", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_H, CATEGORY));
        ...
        leadAlertsKey = KeyBindingHelper.registerKeyBinding(new KeyBinding(
                "key.structure_race.lead_alerts", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_K, CATEGORY));
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            while (leadAlertsKey.wasPressed()) {
                sendOpenBookRequest(StructureRaceNetworking.TYPE_LEAD_ALERTS);
            }
        });
    }
