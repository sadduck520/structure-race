...
public final class StructureRaceConfig {
    ...
    private static java.util.List<String> getRuleBookPagesEn() {
        ...
        pages.add("§l6. Commands§r\n"
                ...
                + "§1/race recall [p]§r (10 pts)\n"
                + "§1/race leave§r §1alerts§r\n"
                + "§l【Admin】§r\n"
                + "§1/race start§r start match\n"
                + "§1/race settings§r GUI\n"
                + "§1/race status§r match status\n"
                + "Join teams with the\n"
                + "compass (team selector)");
        pages.add("§l7. Hotkeys & Chat§r\n"
                + "§1H§r guide · §1P§r points\n"
                + "§1U§r progress §1Y§r lang\n"
                + "§1K§r lead alerts toggle\n"
